...
# 2) Additional tools (toolbox, then twrpbox) are only built
#    if utilities are missing from the primary tool package
...
RECOVERY_BUSYBOX_TOOLS :=
RECOVERY_TOOLBOX_TOOLS :=
RECOVERY_TOYBOX_TOOLS :=
RECOVERY_TWRPBOX_TOOLS :=
