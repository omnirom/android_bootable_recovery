...
LOCAL_ADDITIONAL_DEPENDENCIES := toybox-instlist

TOYBOX_INSTLIST := $(HOST_OUT_EXECUTABLES)/toybox-instlist
RECOVERY_TOYBOX_TOOLS := $(shell $(TOYBOX_INSTLIST))
LOCAL_POST_INSTALL_CMD := \
    $(foreach t,$(RECOVERY_TOYBOX_TOOLS),ln -sf toybox $(TARGET_RECOVERY_ROOT_OUT)/sbin/$(t);)

include $(BUILD_EXECUTABLE)

toybox_upstream_version :=
toybox_sha :=
toybox_version :=
TOYBOX_INSTLIST :=
