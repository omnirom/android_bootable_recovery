...
public:
	...
	bool Restore_Partition(struct RestorePartitionSettings);
...
private:
	...
	bool Make_MD5(bool generate_md5, string Backup_Folder, string Backup_Filename, bool adbbackup); // Generates an MD5 after a backup is made
