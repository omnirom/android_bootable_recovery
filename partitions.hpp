...
public:
	...
	bool Check_Digest(PartitionSettings *part_settings);                      // Checks Digest of a backup
	...
	bool Check_Restore_File_Digest(const string& Filename);                   // Verifies MD5 matches for a file before restoration	
...
private:
	...
	bool Make_Digest(struct PartitionSettings *part_settings);                // Generates an MD5 after a backup is made
