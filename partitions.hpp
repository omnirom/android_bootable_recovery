...
public:
	...
	bool Check_Restore_File_Digest(const string& Filename);                   // Verifies Digest matches for a file before restoration
...
private:
	...
	bool Write_Digest(string Full_File);                                      // Writes digest of file to backup directory
