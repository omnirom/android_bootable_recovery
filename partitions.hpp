...
public:
	...
	bool Backup(PartitionSettings *part_settings);                            // Backs up the partition to the folder specified
...
private:
	...
	bool Backup_Tar(PartitionSettings *part_settings);                        // Backs up using tar for file systems
