...
BSD_TOOLS_USED := $(filter-out $(RECOVERY_BUSYBOX_TOOLS), $(BSD_TOOLS))
OUR_TOOLS_USED := $(filter-out $(RECOVERY_BUSYBOX_TOOLS), $(OUR_TOOLS))
ALL_TOOLS_USED := $(BSD_TOOLS_USED) $(OUR_TOOLS_USED)

ifeq ($(ALL_TOOLS_USED),)

# busybox provides all of these tools,
...
LOCAL_POST_INSTALL_CMD := \
    $(hide) $(foreach t,$(ALL_TOOLS_USED),ln -sf toolbox $(TARGET_RECOVERY_ROOT_OUT)/sbin/$(t);)
...
$(TOOLS_H): PRIVATE_TOOLS := $(ALL_TOOLS_USED)
