...
ifeq ($(shell test $(PLATFORM_SDK_VERSION) -ge 26; echo $$?),0)
    ifeq ($(shell test $(PLATFORM_SDK_VERSION) -ge 28; echo $$?),0)
        LOCAL_CFLAGS += -DUSE_KEYSTORAGE_4 -DHAVE_GATEKEEPER1 -Wno-unused-variable -Wno-sign-compare -Wno-unused-parameter -Wno-comment
        LOCAL_SRC_FILES += Ext4CryptPie.cpp Keymaster4.cpp KeyStorage4.cpp KeyUtil.cpp
        LOCAL_SHARED_LIBRARIES += android.hardware.keymaster@3.0 android.hardware.keymaster@4.0 libkeystore_binder libhidlbase libutils libbinder libkeymaster4support
