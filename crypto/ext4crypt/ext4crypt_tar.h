...
bool e4crypt_policy_get(const char *directory, char *policy,
                               size_t policy_length, int contents_encryption_mode);
void e4crypt_policy_fill_default_struct(struct ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size);
bool e4crypt_policy_set_struct(const char *directory, const struct ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size);
bool e4crypt_policy_get_struct(const char *directory, struct ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size);
