...
extern "C" void e4crypt_policy_fill_default_struct(ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size) {
	if (sizeof(ext4_encryption_policy) != ext4_encryption_policy_size) {
        printf("ext4_encryption_policy size does not match\n");
        return;
    }
...
extern "C" bool e4crypt_policy_set_struct(const char *directory, const ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size) {
    if (sizeof(ext4_encryption_policy) != ext4_encryption_policy_size) {
        printf("ext4_encryption_policy size does not match\n");
        return false;
    }
...
extern "C" bool e4crypt_policy_get_struct(const char *directory, ext4_encryption_policy *eep, const size_t ext4_encryption_policy_size) {
    if (sizeof(ext4_encryption_policy) != ext4_encryption_policy_size) {
        printf("ext4_encryption_policy size does not match\n");
        return false;
    }
