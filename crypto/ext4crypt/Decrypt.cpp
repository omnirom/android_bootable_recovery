...
bool unwrapSyntheticPasswordBlob(const std::string& spblob_path, const std::string& handle_str, const void* application_id, const size_t application_id_size) {
...
bool Decrypt_User_Synth_Pass(const userid_t user_id, const std::string& Password2) {
	...
	// END PIXEL 2 WEAVER
	if (!unwrapSyntheticPasswordBlob(spblob_path, handle_str, (const void*)&application_id[0], PASSWORD_TOKEN_SIZE + SHA512_DIGEST_LENGTH)) {
