...
#define TWRP "TWRP"					//ADB Backup Magic Value
#define TWENDADB "twendadb"				//ADB Backup End Protocol
#define TWCNT "twcnt"					//TWRP Parititon Count Control
#define TWFN "twfn"					//TWRP Filename Control
#define TWIMG "twimg"					//TWRP Image name Control
#define TWEOF "tweof"					//End of File for Image/File
#define MD5TRAILER "md5tr"				//Image/File MD5 Trailer
#define TWMD5 "twmd5"					//Compare MD5 under TWRP
#define TWERROR "twerror"				//Send error to ADB Backup
#define ADB_BACKUP_VERSION 0x01				//TWRP ADB Backup Version
...
struct AdbBackupControlType {
	...
	char type[16];					//stores the type of command, TWENDADB, TWCNT, TWEOF, TWMD5 and TWERROR
...
struct AdbBackupFileTrailer {
	...
	char space[444];				//stores space to align the struct to 512 bytes
};
