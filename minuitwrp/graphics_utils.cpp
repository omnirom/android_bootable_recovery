...
{                                                                             \
    for (size_t y = 0; y < src->height; y++) {                                \
        for (size_t x = 0; x < src->width; x++) {                             \
            ...
            size_t x_disp = HWROTATION_X_DISP(x, y, dst);                     \
            size_t y_disp = HWROTATION_Y_DISP(x, y, dst);                     \
                                                                              \
...
void surface_hwrotation_transform(gr_surface dst_ptr, const gr_surface src_ptr,
