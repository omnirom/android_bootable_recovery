...
# This script was originally made by https://github.com/suky for his chinese version of TWRP and then
# translated to English by feilplane at #twrp of irc.freenode.net.
# However, it was not compatible with vanilla TWRP, so https://github.com/Tasssadar rewrote most of
# it and it now has very little in common with the original script.
