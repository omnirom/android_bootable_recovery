...
bool TWPartitionManager::Make_MD5(bool generate_md5, string Backup_Folder, string Backup_Filename)
{
	...
	gui_msg("generating_md5= * Generating md5...");
...
void TWPartitionManager::Clean_Backup_Folder(string Backup_Folder) {
	...
	if (d == NULL) {
		gui_msg(Msg(msg::kError, "error_opening_dir=Error opening dir: '{1}'")(Backup_Folder));
		return;
	}
...
void TWPartitionManager::Set_Restore_Files(string Restore_Name) {
	...
	if (d == NULL)
	{
		gui_msg(Msg(msg::kError, "error_opening=Error opening '{1}'")(Restore_Name));
		return;
	}
...
int TWPartitionManager::Partition_SDCard(void) {
	...
	if (fp == NULL) {
		gui_msg(Msg(msg::kError, "error_opening=Error opening {1}")("/proc/partitions"));
		return false;
	}
