...
bool twrpSHA256::verify_digest(std::string digest) {
	shaverify = twrpSHA256::return_digest_string();
	if (shaverify != digest) {
		return false;
	}
	return true;
...
bool twrpSHA512::verify_digest(std::string digest) {
	shaverify = twrpSHA512::return_digest_string();
	if (shaverify != digest) {
		return false;
	}
	return true;
