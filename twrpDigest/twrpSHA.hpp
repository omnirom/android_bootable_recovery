...
private:
	uint8_t sha256_store;                                    // Initialize the SHA256 digest variable that holds the computation
...
private:
	uint8_t sha512_store;                                    // Initialize the SHA512 digest variable that holds the computation
