...
bool TWPartition::Process_Fstab_Line(string Line, bool Display_Error) {
	...
	if (Flags.size() > 0) {
		...
		bool has_display_name = Prev_Display_Name != Display_Name;
		bool has_storage_name = Prev_Storage_Name != Storage_Name;
		bool has_backup_name = Prev_Backup_Display_Name != Backup_Display_Name;
