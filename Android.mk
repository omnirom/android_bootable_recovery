...
ifneq ($(TW_INCLUDE_DEVICESPECIFIC),)
	LOCAL_CFLAGS += -DTW_INCLUDE_DEVICESPECIFIC
endif
ifneq ($(TW_DEVICESPECIFIC_PATH),)
	LOCAL_CFLAGS += -DTW_DEVICESPECIFIC_PATH=$(TW_DEVICESPECIFIC_PATH)
endif
ifneq ($(TW_INCLUDE_DEVICESPECIFIC_LANGUAGE),)
	LOCAL_CFLAGS += -DTW_INCLUDE_DEVICESPECIFIC_LANGUAGE=$(TW_INCLUDE_DEVICESPECIFIC_LANGUAGE)
endif
