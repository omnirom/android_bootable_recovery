...
{
public:
	Page(xml_node<>* page, xml_node<>* templates = NULL, xml_node<>* templates2 = NULL);
	virtual ~Page();
...
protected:
	bool ProcessNode(xml_node<>* page, xml_node<>* templates = NULL, xml_node<>* templates2 = NULL, int depth = 0);
};
...
public:
    ...
    int CheckAdditional(ZipArchive* package, xml_node<>* templates);
...
protected:
	int LoadPages(xml_node<>* pages, xml_node<>* templates = NULL, xml_node<>* templates2 = NULL);
