...
protected:
	...
	int firstDisplayedLine; // this line goes at the top of the display list - may only be partially visible
	...
	int y_offset; // this is how many pixels offset in the y axis for per pixel scrolling, is always <= 0 and should never be < -actualLineHeight
