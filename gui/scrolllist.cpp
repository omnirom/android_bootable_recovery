...
{
	RenderStdItem(itemindex, yPos, selected, NULL, "implement RenderItem!");
}

void GUIScrollList::RenderStdItem(size_t itemindex, int yPos, bool selected, ImageResource* icon, const char* text)
{
	...
	gr_textEx(mRenderX + maxIconWidth + 5, yPos + fontOffsetY, text, mFont->GetResource());
}
