...
#if defined(TW_OEM_BUILD) && !defined(EXCLUDE_TWRP_APP)
	mPersist.SetValue("tw_exclude_twrp_app", "0");
	mPersist.SetValue("tw_app_install_system", "0");
#elif !defined(EXCLUDE_TWRP_APP)
	mPersist.SetValue("tw_exclude_twrp_app", "0");
	mPersist.SetValue("tw_app_install_system", "1");
#else
	mPersist.SetValue("tw_exclude_twrp_app", "1");
#endif
